...
export type EspaciosQuery = { __typename?: 'Query', espacios: Array<{ __typename?: 'Espacio', id: number, nombre: string, img?: string | null, ubicacion: string }> };
 ...
 * });
 */
export function useEspaciosQuery(baseOptions?: Apollo.QueryHookOptions<EspaciosQuery, EspaciosQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<EspaciosQuery, EspaciosQueryVariables>(EspaciosDocument, options);
      }
export function useEspaciosLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<EspaciosQuery, EspaciosQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<EspaciosQuery, EspaciosQueryVariables>(EspaciosDocument, options);
        }
export type EspaciosQueryHookResult = ReturnType<typeof useEspaciosQuery>;
export type EspaciosLazyQueryHookResult = ReturnType<typeof useEspaciosLazyQuery>;
export type EspaciosQueryResult = Apollo.QueryResult<EspaciosQuery, EspaciosQueryVariables>;
 ...
 * });
 */
export function useEspacioQuery(baseOptions: Apollo.QueryHookOptions<EspacioQuery, EspacioQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<EspacioQuery, EspacioQueryVariables>(EspacioDocument, options);
      }
export function useEspacioLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<EspacioQuery, EspacioQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<EspacioQuery, EspacioQueryVariables>(EspacioDocument, options);
        }
...
export type EspacioQueryResult = Apollo.QueryResult<EspacioQuery, EspacioQueryVariables>;
